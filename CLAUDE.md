...
- migrations: 0001_init · 0002_add_cod_enabled · 0003_chat_messages · 0004_customer_tags · 0005_store_hours
...
- **admin UI ครบ 7 หน้า** (feature-complete): Dashboard (สรุป+date picker เลือกวัน US-13), Orders (สถานะ/ยกเลิก/COD/realtime/⬇CSV export), Menu (**CRUD เต็ม**: เพิ่ม/แก้/ลบ+หมวด+รูป US-14 · GET /admin/menu/categories), Customers, Chat, Users&RBAC(owner), Settings · US-13/14 done · US-19 CSV แล้ว (margin/breakeven ยัง — รอ field ต้นทุนต่อเมนู)
